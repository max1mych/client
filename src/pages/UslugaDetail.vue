    ...
    <main class="d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid align-items-center mx-auto px-5 mb-5">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <!--Картинка-->
                <div class="col-xl-6 col-sm-12 m-3 ">
                    <div>

                        <div class="image-preview d-flex justify-content-center mx-auto mb-3 mt-5">
                            <img :src="'http://localhost:5000/' + usluga.img" alt="" class="usluga-img img-fluid">
                        </div>
                    </div>
                </div>
            </div>
